...
export const PLATFORM_TIER_CATALOG: PlatformTierCatalogItem[] = [
  ...
  },
  {
    ...
    price: "$249",
    period: "/month",
    users: "Up to 5 Users · 1 Business",
  ...
  },
  {
    ...
    price: "$499",
    period: "/month",
    users: "Unlimited Users · Up to 5 Businesses",
    outcome: "For businesses running multiple operations, larger teams and specialist industry integrations.",
    features: [
      "Everything in Growth",
      "Advanced AI & automation",
      "Industry integrations & API access",
      "Up to 5 active businesses",
      "Separate secure workspace for each business",
      "Multiple pipelines",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    users: "Unlimited Users · Businesses by agreement",
    outcome: "For organisations needing custom structure, integrations and more than five active businesses.",
    features: [
      "Everything in Scale",
      "Business allowance / custom structure by agreement",
      "Industry integrations & API access",
      "White label",
