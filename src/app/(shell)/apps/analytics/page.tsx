import { AnalyticsBusinessIntelligence } from "@/components/analytics/AnalyticsBusinessIntelligence";
  ...
  return (
    <>
      ...
      <main className="dg-page-main space-y-6">
        ...
        <AnalyticsBusinessIntelligence insights={data.insights} />

        <section className="dg-card">
          <h2 className="font-semibold text-white">Key metrics</h2>
          <p className="mt-1 text-sm text-slate-500">High-level KPIs with context — inspect the evidence behind Intelligence surfaces.</p>
        ...
        <section className="dg-card">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">Inspect lead volume over time, then drill into source, status and opportunity value in CRM.</p>
            </div>
        ...
        <section className="dg-card">
          ...
          <p className="mt-1 text-sm text-slate-500">Scores and counts from connected systems. Missing data shows how to connect — never fake metrics.</p>
        ...
        <section className="dg-card">
          ...
          <ul className="mt-3 space-y-2 text-sm text-slate-300">
            <li><Link href="/apps/analytics/dashboard" className="text-sky-400 hover:underline">Dashboard</Link>{" "}— predefined executive, sales, marketing and operations views</li>
            <li><Link href="/apps/analytics/reports" className="text-sky-400 hover:underline">Reports</Link>{" "}— formal business performance reports with AI commentary</li>
            <li><Link href="/apps/analytics/connectors" className="text-sky-400 hover:underline">Data sources</Link>{" "}— connected systems feeding Analytics and your Digital Twin</li>
            <li><Link href="/dashboard/insights" className="text-sky-400 hover:underline">Insights</Link>{" "}— what DigitalGate is noticing (Intelligence interpretation)</li>
          </ul>
        </section>
      </main>
    </>
