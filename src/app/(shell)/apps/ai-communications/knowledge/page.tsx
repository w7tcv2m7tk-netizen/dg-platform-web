  ...
  return (
    <>
      <header className="dg-page-header">
        ...
        <CommsSubnav active="/apps/ai-communications/knowledge" />
      </header>
      <main className="dg-page-main space-y-6">
        {!session ? (
          <div className="dg-card">
            <p className="text-sm text-slate-400">Sign in to view agent knowledge.</p>
          </div>
        ) : (
          <>
            <div className="dg-card">
              ...
              <p className="mt-1 text-sm text-slate-400">
                Read-only snapshot from your Digital Business Identity — no vector database in this
                phase.
              </p>
                ...
                <dl className="mt-3 space-y-3 text-sm">
                  {voice.tagline ? (
                    <div>
                      ...
                      <dd className="text-white">{voice.tagline}</dd>
                    </div>
                  ) : null}
                  {voice.tone ? (
                    <div>
                      <dt className="text-slate-500">Tone</dt>
                      <dd className="text-white">{voice.tone}</dd>
                    </div>
                  ) : null}
                  {voice.services ? (
                    <div>
                      <dt className="text-slate-500">Services</dt>
                      <dd className="whitespace-pre-wrap text-white">{voice.services}</dd>
                    </div>
                  ) : null}
                  {voice.targetAudience ? (
                    <div>
                      <dt className="text-slate-500">Target audience</dt>
                      <dd className="text-white">{voice.targetAudience}</dd>
                    </div>
                  ) : null}
                </dl>
              </div>
            ...
            <div className="dg-card">
              <p className="text-sm text-slate-400">
                Update source data in Business Profile to refresh what agents know about your
                business.
              </p>
              <Link
