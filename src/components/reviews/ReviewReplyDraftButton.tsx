  ...
  return (
    <div className="mt-3">
      <button
        ...
        onClick={generate}
        disabled={loading}
        className="min-h-11 rounded-full border border-slate-600 px-3 py-2 text-xs font-medium text-slate-200 hover:border-blue-500 disabled:opacity-50"
      >
      ...
      {open && draft ? (
        <div className="mt-3 rounded-lg border border-slate-700 bg-slate-950/60 p-3">
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              type="button"
              className="min-h-11 px-2 text-xs text-slate-500 hover:text-slate-300"
