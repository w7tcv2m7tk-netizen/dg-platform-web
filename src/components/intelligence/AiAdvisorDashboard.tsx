          ...
          <div className="mt-6 rounded-xl border border-violet-500/20 bg-violet-500/5 px-4 py-4">
            ...
            <p className="mt-3 text-xs text-slate-500">
              {liveAnswer.source === "llm"
                ? "Live Advisor response"
                : liveAnswer.source === "error"
                  ? "Request failed"
                  : "Using your current DigitalGate briefing while live AI reasoning is unavailable."}
            </p>
          </div>
        ) : activeAnswer ? (
          <div className="mt-6 rounded-xl border border-violet-500/20 bg-violet-500/5 px-4 py-4">
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-400">
              Prioritisation from Business Brain, available business evidence and enabled DigitalGate apps — execute in Command Centre.
            </p>
          </div>
