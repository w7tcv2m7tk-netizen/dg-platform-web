  ...
  return (
    <div className="dg-card border border-amber-500/30 bg-amber-500/5">
      ...
      <p className="mt-2 text-sm text-slate-300">
        This organisation isn’t enrolled in the Accommodation beta yet. Ask DigitalGate to enable{" "}
        <code className="text-amber-200">acc.beta</code> in Command Centre, or create a new business
        with the Accommodation template.
      </p>
