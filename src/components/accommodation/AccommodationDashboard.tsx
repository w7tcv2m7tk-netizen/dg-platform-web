    ...
    return (
      <div className="space-y-6">
        <div className="dg-card border-amber-500/30">
          <h2 className="font-semibold text-white">Accommodation is temporarily unavailable</h2>
          <p className="mt-2 text-sm text-amber-300">{error}</p>
          <p className="mt-2 text-sm text-slate-400">
            Refresh this page to try the native Accommodation summary again. Your units, bookings and
            availability are not changed by this loading error.
          </p>
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              href="/apps/accommodation/units"
              className="inline-flex min-h-11 items-center rounded-full border border-slate-600 px-5 py-2 text-sm font-semibold text-slate-200 hover:border-blue-500"
            >
              Open units
            </Link>
            <Link
      ...
      <div className="space-y-6">
        <div className="dg-card border-dashed border-slate-700">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              href="/apps/accommodation/units"
              className="inline-flex min-h-11 items-center rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-500"
            >
              Open units
            </Link>
            <Link
              href="/apps/accommodation/calendar"
              className="inline-flex min-h-11 items-center rounded-full border border-slate-600 px-5 py-2 text-sm text-slate-300 hover:bg-slate-900"
            >
              Open availability
            </Link>
          </div>
      ...
      <div className="flex flex-wrap gap-2 text-sm">
        {[
          ...
          <Link
            key={l.href}
            href={l.href}
            className="inline-flex min-h-11 items-center rounded-full border border-slate-700 px-3 py-2 text-slate-300 hover:border-blue-500 hover:text-white"
          >
            {l.label}
          </Link>
        ))}
      ...
      {summary.recent_bookings.length ? (
        <div className="dg-card">
          <div className="flex items-center justify-between gap-2">
            ...
            <Link
              href="/apps/accommodation/bookings"
              className="inline-flex min-h-11 items-center px-2 text-xs text-blue-400 hover:underline"
            >
              View all →
            </Link>
          </div>
