...
type State = { configured: boolean; environment: "sandbox" | "live"; status: string; lastVerifiedAt: string | null; lastError: string | null };
  ...
  return (
    <section className="dg-card space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button type="button" disabled={busy || !apiKey || !apiSecret} onClick={connect} className="rounded-full bg-blue-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-50">{busy ? "Verifying…" : "Verify & connect"}</button>
