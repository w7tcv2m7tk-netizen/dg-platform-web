...
export function InviteFoundingResellerForm({ compact }: { compact?: boolean }) {
  ...
  return (
    <div className={compact ? "space-y-3" : "dg-card space-y-3"}>
      <h2 className="font-semibold text-white">Invite Founding Acquisition Partner</h2>
      <p className="text-sm text-slate-400">
        Personal invitation into the Founding Acquisition Partner Programme. Sending an invite
