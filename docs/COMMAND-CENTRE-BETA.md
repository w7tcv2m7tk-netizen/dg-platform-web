...
- [foundations/BUSINESS-DISCOVERY.md](./foundations/BUSINESS-DISCOVERY.md) — Business Discovery Engine (providers + import)  
- [foundations/OPPORTUNITY-ENGINE.md](./foundations/OPPORTUNITY-ENGINE.md) — Opportunity Engine Daily Briefing  
