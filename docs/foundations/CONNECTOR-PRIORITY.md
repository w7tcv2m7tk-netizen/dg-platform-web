...
| Channel | Adapters |
|---------|----------|
| Email | Google (live) · Microsoft 365 (live) · **Apple iCloud (live — app-specific password)** · **Resend** (transactional / platform) |
...
| 4 | **Google** | 1 / 2 | **GBP OAuth + locations/profile sync**; reviews best-effort into Reputation. APIs live on allowlisted Cloud project `742705345842` only — [GOOGLE-GBP.md](../connectors/GOOGLE-GBP.md) |
