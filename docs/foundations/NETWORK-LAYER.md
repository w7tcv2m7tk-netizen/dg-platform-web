...
**Reviews and Business Referrals** (trust + job introductions between members) are specified separately — Phase 5+ timing: [REVIEWS-AND-REFERRALS.md](./REVIEWS-AND-REFERRALS.md) §§B–C. **Platform Refer & Earn** (customers refer DigitalGate SaaS) is Core/Billing — same doc §A — not this Network surface.
...
| **Phase 5+** | Reviews App · Business Referral Engine / network (non-financial first; Paid/Commission behind compliance packs) — [REVIEWS-AND-REFERRALS.md](./REVIEWS-AND-REFERRALS.md) §§B–C. Platform Refer & Earn is Core/Billing (§A), not this row. |
