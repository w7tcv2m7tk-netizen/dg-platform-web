...
| **Founding** | Limited access / influence (early access, priority onboarding, roadmap input) at **standard published pricing** — not a recurring % discount. Referral commissions (20/15/10) are separate. |
