...
| OTA gaps / double-book risk | Confirm import+export URLs; never OTA↔OTA; cron pulls daily 05:00 UTC (Vercel plan limit) — still check Units “Last synced”; native APIs needed for real-time |
