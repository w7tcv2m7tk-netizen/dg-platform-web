...
export const CLEANER_TEMPLATE: ServiceTemplate = {
  ...
  jobTypes: [
    { id: "recurring_site_service", label: "Recurring site service" },
    { id: "venue_clean", label: "Venue clean" },
    { id: "office_clean", label: "Office clean" },
    { id: "hospitality_clean", label: "Hospitality clean" },
    { id: "deep_clean", label: "Deep clean" },
    { id: "periodic_clean", label: "Periodic clean" },
    { id: "event_clean", label: "Event / function clean" },
    { id: "end_of_lease", label: "End-of-lease clean" },
    { id: "carpet_clean", label: "Carpet clean" },
    { id: "window_clean", label: "Window clean" },
    { id: "pressure_clean", label: "Pressure clean" },
    { id: "inspection", label: "Site inspection / QA" },
    { id: "client_request", label: "Client service request" },
  ],
  workflow: [
    { id: "new_enquiry", label: "New enquiry" },
    ...
    { id: "scheduled", label: "Scheduled" },
    { id: "assigned", label: "Team assigned" },
    { id: "in_progress", label: "Service in progress" },
    { id: "qa", label: "QA / inspection" },
    { id: "completed", label: "Service completed" },
    { id: "client_review", label: "Client review / issue" },
    { id: "invoiced", label: "Invoiced" },
    { id: "recurring", label: "Recurring service" },
  ],
  jobFields: [
    { id: "site_contact", label: "Site contact", type: "text" },
    { id: "scope_of_works", label: "Scope of works / cleaning specification", type: "textarea" },
    { id: "areas_zones", label: "Areas / zones", type: "textarea" },
    { id: "service_frequency", label: "Service frequency", type: "text" },
    { id: "recurring", label: "Recurring contract", type: "boolean" },
    { id: "access_requirements", label: "Access, keys & alarm instructions", type: "textarea" },
    { id: "site_hazards", label: "Site hazards / WHS notes", type: "textarea" },
    { id: "checklist", label: "Site checklist / task notes", type: "textarea" },
    { id: "chemicals_sds", label: "Chemicals / SDS requirements", type: "textarea" },
    { id: "equipment_required", label: "Equipment required", type: "textarea" },
    { id: "consumables", label: "Consumables / restocking requirements", type: "textarea" },
    { id: "qa_requirements", label: "QA / inspection requirements", type: "textarea" },
    { id: "proof_of_service", label: "Proof-of-service / photo requirements", type: "textarea" },
    { id: "incident_notes", label: "Incident / damage notes", type: "textarea" },
  ],
...
const TEMPLATES: Record<ServiceTemplateKey, ServiceTemplate> = {
  electrician: ELECTRICIAN_TEMPLATE, plumber: PLUMBER_TEMPLATE, builder: BUILDER_TEMPLATE, cleaner: CLEANER_TEMPLATE,
...
const SERVICE_TEMPLATE_KEYS_ORDERED: ServiceTemplateKey[] = ["electrician", "plumber", "builder", "cleaner", "landscaper", "hvac", "pest_control", "painter", "handyman", "solar", "pool_service", "general"];
