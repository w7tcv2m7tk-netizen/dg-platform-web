...
export const PLANNED_CONNECTOR_MANIFESTS: ConnectorManifest[] = [
  ...
  {
    id: "twilio",
    name: "Twilio (telephony adapter — first)",
    category: "marketing",
    auth: "api_key",
    syncObjects: ["Contact"],
    capabilities: ["sms.send", "voice.call", "numbers.provision"],
    appIds: ["communications", "ai-communications"],
    priorityTier: 3,
    dg15Rank: 14,
  },
  {
    id: "telnyx",
    name: "Telnyx (telephony adapter — evaluate)",
    category: "marketing",
    auth: "api_key",
    syncObjects: ["Contact"],
    capabilities: ["sms.send", "voice.call", "numbers.provision"],
