...
export const PLANNED_CONNECTOR_MANIFESTS: ConnectorManifest[] = [
  ...
  { id:"meta", name:"Meta (Facebook / Instagram)", category:"marketing", auth:"oauth", maturity:"native", syncObjects:["Organisation","Campaign"], capabilities:["profile.read","insights.read","ads.read"], appIds:["social","advertising"], priorityTier:1, dg15Rank:10 },
  { id:"google-ads", name:"Google Ads", category:"marketing", auth:"oauth", maturity:"native", syncObjects:["Campaign"], capabilities:["ads.read","insights.read"], appIds:["advertising"], priorityTier:1 },
  { id:"youtube", name:"YouTube", category:"marketing", auth:"oauth", maturity:"native", syncObjects:["Organisation","Activity"], capabilities:["profile.read","content.read","insights.read"], appIds:["social"], priorityTier:1 },
  ...
  { id:"illion-bankstatements", name:"illion BankStatements", category:"finance", auth:"api_key", maturity:"planned", syncObjects:["Contact","FinanceApplication","Document"], capabilities:["statement.request","statement.receive","statement.data.read","income.read","expense.read","transaction.read","document.read"], countries:["AU","NZ"], appIds:["finance"], industryTemplateIds:["mortgage_broking"], priorityTier:2 },
  { id:"equifax-au", name:"Equifax Australia", category:"finance", auth:"oauth", maturity:"planned", syncObjects:["Contact","FinanceApplication","Document"], capabilities:["credit.report.request","credit.report.read","identity.verify","risk.insights.read"], countries:["AU"], appIds:["finance"], industryTemplateIds:["mortgage_broking"], priorityTier:2 },
  { id:"vedacheck", name:"Vedacheck", category:"finance", auth:"api_key", maturity:"planned", syncObjects:["Contact","FinanceApplication","Document"], capabilities:["credit.check.request","credit.report.read","identity.verify","document.read"], countries:["AU"], appIds:["finance"], industryTemplateIds:["mortgage_broking"], priorityTier:2 },
