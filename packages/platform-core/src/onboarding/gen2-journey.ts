...
export type Gen2VipSetup = {
  ...
  operatingProfileStep?: Gen2OperatingProfileStep;
  platformPreparationStep?: Gen2PlatformPreparationStep;
  primaryIndustryId?: string;
  secondaryIndustryIds?: string[];
  recommendedGrowthApps?: string[];
  firstLoginHandoverCompletedAt?: string | null;
  appearance: Gen2PlatformAppearance;
  timezone: string;
  locale: string;
  currency: string;
  ...
  connections?: Partial<Record<Gen2ConnectionProvider, {
    requested: boolean;
    requestedCapabilities: Gen2ConnectionCapability[];
...
export function emptyGen2Progress(founding = false): Gen2OnboardingProgress {
  ...
  return {
    ...
    vipSetup: {
      ...
      locale: "en-AU",
      currency: "AUD",
      operatingProfileStep: "industry",
      platformPreparationStep: "brand",
      connections: {},
    },
  };
}
