...
export const PLATFORM_ROADMAP: RoadmapItem[] = [
  ...
  },
  {
    ...
    area: "Real Estate",
    label: "Buyer leads",
    description: "Buyer pipeline, matching, and consultation bookings",
    status: "planned",
    appId: "real-estate",
  ...
  },
  {
    ...
    area: "Real Estate",
    label: "Bookings",
    description: "Appraisal and consultation booking calendar",
    status: "planned",
    appId: "real-estate",
  ...
  // —— Accommodation ——
  {
    ...
    area: "Accommodation",
    label: "Overview",
    description: "Hospitality dashboard — units, occupancy, and revenue",
    status: "planned",
    appId: "accommodation",
  ...
  },
  {
    ...
    area: "Accommodation",
    label: "Bookings",
    description: "Reservations, check-in, and guest communications",
    status: "planned",
    appId: "accommodation",
