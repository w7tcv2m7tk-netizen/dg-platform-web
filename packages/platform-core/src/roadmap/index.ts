...
export const PLATFORM_ROADMAP: RoadmapItem[] = [
  ...
  // —— Services (one App · Universal Objects + Service Templates — docs/foundations/SERVICES-APP.md) ——
  {
    id: "services.engine",
    area: "Services",
    label: "Shared Service Engine",
    description:
      "DG OS for service businesses (ServiceM8-class coverage on Core) — not a FSM clone — docs/foundations/SERVICES-APP.md",
    status: "in_progress",
    priority: "high",
    appId: "services",
    href: "/apps/services",
  ...
  {
    id: "services.field_ops",
    area: "Services",
    label: "Field operations",
    description:
      "Mobile tech UX — instructions, photos, signatures, checklists, forms, time, materials, completion",
    status: "planned",
    priority: "medium",
    appId: "services",
  ...
  {
    id: "services.recurrence",
    area: "Services",
    label: "Recurring jobs & contracts",
    description:
      "Recurring appointments + Service Contract objects — not metadata-only flags",
    status: "planned",
    priority: "medium",
    appId: "services",
    href: "/apps/services/jobs",
  ...
  {
    id: "services.quote_job",
    area: "Services",
    label: "Quote ↔ job ↔ invoice",
    description:
      "Quote-to-job conversion and invoice auto-create from completed jobs (Commerce)",
    status: "planned",
    priority: "medium",
    appId: "services",
    href: "/apps/services/jobs",
  ...
  {
    id: "services.ai_job_assistant",
    area: "Services",
    label: "AI Job Assistant",
    description:
      "Tech notes → update job, notes, Opportunity, draft customer message, suggest upsell (human review)",
    status: "planned",
    priority: "medium",
    appId: "services",
    href: "/apps/services/jobs",
  ...
  {
    id: "services.ai_quote_assistant",
    area: "Services",
    label: "AI Quote Assistant",
    description:
      "Natural language → structured Commerce quote for review",
    status: "planned",
    priority: "medium",
    appId: "services",
  ...
  {
    id: "services.ai_scheduling",
    area: "Services",
    label: "AI scheduling recommendations",
    description:
      "Recommend slots from skills, location, duration, urgency, travel, existing bookings",
    status: "planned",
    priority: "low",
    appId: "services",
  ...
  },
  {
    ...
    area: "Services",
    label: "Quotes",
    description: "Service quotes via Commerce redirect + soft job links (Universal Objects)",
    status: "done",
    appId: "services",
  ...
  },
  {
    ...
    description:
      "Payment completed, quote accepted → notify+task, invoice overdue scan → notify",
    status: "done",
    appId: "automation",
  },
  ...
  },
  {
    ...
    description:
      "Core detection + scoring + next-best-action; Command Centre Opportunities cockpit + Create task",
    status: "done",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Ranked platform opportunities (attention, prospects, expansion) — Open + Create task CTAs",
    status: "done",
    appId: "command-centre",
    href: "/command/opportunities",
  },
