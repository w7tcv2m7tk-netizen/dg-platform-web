...
import { communicationsApp } from "./builtins/communications";
...
const BUILTIN_APPS: RegisteredApp[] = [
  ...
  { manifest: communicationsApp, enabled: true },
  ...
  { manifest: financeApp, enabled: true },
  { manifest: servicesApp, enabled: true },
  { manifest: creatorApp, enabled: false },
  { manifest: commercialApp, enabled: true },
  { manifest: propertyManagementApp, enabled: true },
