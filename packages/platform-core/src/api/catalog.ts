...
export const PLATFORM_API_V1: PlatformApiEndpoint[] = [
  ...
  { method: "DELETE", path: "/api/v1/contacts/{id}", description: "Delete contact", feature: "crm.contacts.write", auth: "session_or_api_key" },
  ...
  { method: "GET", path: "/api/v1/companies/{id}", description: "Get company", feature: "crm.companies.read", auth: "session_or_api_key" },
  { method: "PATCH", path: "/api/v1/companies/{id}", description: "Update company", feature: "crm.companies.write", auth: "session_or_api_key" },
  { method: "DELETE", path: "/api/v1/companies/{id}", description: "Delete company", feature: "crm.companies.write", auth: "session_or_api_key" },
  { method: "GET", path: "/api/v1/opportunities", description: "List opportunities", feature: "crm.opportunities.read", auth: "session_or_api_key" },
  { method: "DELETE", path: "/api/v1/opportunities/{id}", description: "Delete opportunity", feature: "crm.opportunities.write", auth: "session_or_api_key" },
