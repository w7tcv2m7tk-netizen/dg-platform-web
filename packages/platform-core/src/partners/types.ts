...
export const PARTNER_COMMISSION_CONFIG: Record<PartnerType, PartnerTierConfig> = {
  FOUNDING_RESELLER: {
    ...
    programme: "Acquisition Partners",
    seatCap: 10,
  ...
  CHANNEL_MANAGER: {
    ...
    programme: "Acquisition Channel Management",
    seatCap: null,
    platformSubscriptionCommission: true,
  },
  FOUNDING_10_REFERRAL: {
    ...
    programme: "Founding Customer Referral",
    seatCap: null,
    platformSubscriptionCommission: true,
  },
  FOUNDING_PARTNER: {
    commissionBps: BPS.FOUNDING_100_REFERRAL,
    durationMonths: COMMISSION_PERIOD_MONTHS,
  ...
  FOUNDING_CUSTOMER: {
    commissionBps: BPS.FOUNDING_1000_REFERRAL,
    durationMonths: COMMISSION_PERIOD_MONTHS,
  ...
  CUSTOMER_REFERRER: {
    commissionBps: BPS.STANDARD_REFERRAL,
    durationMonths: COMMISSION_PERIOD_MONTHS,
    label: "Standard Referrer",
    programme: "Refer & Earn",
    seatCap: null,
    platformSubscriptionCommission: true,
  },
  IMPLEMENTATION_PARTNER: {
