...
export const COMMERCIAL_MODEL_SUMMARY = {
  ...
  channelManager: {
    ...
    note: `${bpsToPercentLabel(BPS.CHANNEL_MANAGER_OVERRIDE)} override on qualifying Platform + App revenue generated by Acquisition Partners they directly manage, for the first ${COMMISSION_PERIOD_MONTHS} months of each referred customer — not a single 30% partner rate.`,
  ...
  deliveryPartner: {
    ...
    note: "No Platform subscription commission. Service revenue only.",
  ...
  deliveryChannelManager: {
    ...
    note: `${bpsToPercentLabel(BPS.DELIVERY_CHANNEL_MANAGER_OVERRIDE)} override on qualifying Professional Services + Support & Success revenue generated by Delivery Partners they directly manage.`,
